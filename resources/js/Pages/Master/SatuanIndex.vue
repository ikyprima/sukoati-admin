    ...
    <AdminLayout>
        ...
        <div class="flex flex-wrap mt-4">
            <div class="w-full mb-12 px-4">
                ...
                <card-table @clickedit="clickedit" @clichapus="clickHapus" :list=listSatuan.data :header=setting
                    ...
                    <template #button>
                        <div class="hidden md:block">
                            ...
                            <button
                                ...
                                type="button" @click="tambahSatuan">
                ...
                <footer class="px-2 py-4 border-t border-gray-100 bg ">
                    <nav aria-label="Page navigation example ">
                        <ul class="flex list-style-none ">
                            <li class="page-item" v-for="paging in listSatuan.links" :key="paging.id">
                    ...
                    <form @submit.prevent="">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            " v-model="formsatuan.nama" />
                                <p v-if="formsatuan.errors.nama" class="mt-2 text-sm text-red-600 dark:text-red-500">{{
                                    formsatuan.errors.nama }}</p>
                            </div>
                            <div class="relative mb-2">
                                ...
                                focus:border-blue-600
                                focus:outline-none
                            " v-model="formsatuan.singkatan" />
                                <p v-if="formsatuan.errors.singkatan" class="mt-2 text-sm text-red-600 dark:text-red-500">
                                    {{ formsatuan.errors.singkatan }}</p>
                            </div>
...
export default {
    ...
    methods: {
        ...
        tambahSatuan() {
            this.editMode = false;
            this.setUbahSatuan = true;
            this.showModal = !this.showModal;
            this.formsatuan.reset()
            this.formsatuan.clearErrors()
        ...
        simpan() {
            ...
            if (this.editMode == true) {
                ...
                this.formsatuan.put(route('master.satuan.update', this.setUbahSatuan.id), {
                    preserveScroll: true,
                    preserveState: true,
                    onSuccess: () => {
                        this.showModal = !this.showModal;
                        this.setUbahSatuan = null;
                        this.formsatuan.reset('nama');
                        this.formsatuan.reset('singkatan');
                        // this.pagings(this.path+'?page='+this.halaman);
                    }
                })

            } else {
                this.formsatuan.post(route('master.satuan.simpan'), {
                    preserveScroll: true,
                    preserveState: true,
                    onSuccess: () => {
                        this.showModal = !this.showModal;
        ...
        clickedit(value) { //klik ubah
            ...
            this.editMode = true;
            this.showModal = !this.showModal;
            this.setUbahSatuan = value;
            this.formsatuan.nama = value.nama;
            this.formsatuan.singkatan = value.singkatan;
        ...
        hapus() {
            this.formsatuan.delete(route('master.satuan.hapus', this.setHapusSatuan.id), {
                preserveScroll: true,
                preserveState: true,
                onSuccess: () => {
                    this.dialogHapus = !this.dialogHapus;
                    this.setHapusSatuan = null;
                    this.formsatuan.reset()
                    // this.pagings(this.path+'?page='+this.halaman);
                }
